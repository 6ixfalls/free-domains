...
- _your-name_**.freeclashroyalegems.xyz**

> Note that **.xyz** is considered global by Google just like **.com**
...
Let's say you want the domain **example.freeclashroyalegems.xyz**
...
```sh
nslookup -type=ns example.freeclashroyalegems.xyz
```

If you see something like **server can't find example.freeclashroyalegems.xyz: NXDOMAIN**, your domain is available.

#### Option 2

Search in the file [zones/freeclashroyalegems.xyz.yaml](zones/freeclashroyalegems.xyz.yaml) for the term "example" to see if it's already registered
...
> Some of the links above are referral links to support the original repo
...
For **example.freeclashroyalegems.xyz**, edit the zone file [zones/freeclashroyalegems.xyz.yaml](zones/freeclashroyalegems.xyz.yaml), and follow the format used by the other domains to set the nameservers given by your DNS provider.
...
**If you think a domain is abusing our system, please [open an issue](https://github.com/6ixfalls/free-domains/issues)**